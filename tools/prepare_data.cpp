...
int main(int argc, char* argv[]) {
  ...
  std::string vocab_path, load_vocab_path, vocab_file, merges_file, download_url, download_hf;
  ...
  bool use_bpe = !vocab_file.empty() && !merges_file.empty();
  if (use_bpe && (vocab_file.empty() || merges_file.empty())) {
